...
void set_material(int m)
{
	if(m==0)
	{
		float materialGrey[]={0.9,0.4,0.6},materialWhite[]={0.2,0.5,0.2};
	...
	if(m==ROLLER_BODY)
	{	float materialColours[][3]={{0.0,1.0,0.0},{1,0.6,0.3}, {0.2,0.2,0.2},  {0.75,0.164,0.164},{0.601,0.19,1.0}, {1,1,0}},materialLightBr[]={0.2,0.2,0.0};
...
GLuint LoadBMP(const char *fileName)
{
	...
	width		= *(int*)&(header[0x25]);	//dec18, Image Width
...
void initSky()
{
	...
	if(background==0)
	{	skybox[SKY_DOWN] = LoadBMP("C:\\Users\\hp\\OneDrive\\Desktop\\mini\\BMP11\\down.bmp");
		skybox[SKY_FRONT] = LoadBMP("C:\\Users\\hp\\OneDrive\\Desktop\\mini\\BMP11\\front.bmp");
		skybox[SKY_BACK] = LoadBMP("C:\\Users\\hp\\OneDrive\\Desktop\\mini\\BMP11\\back.bmp");
		skybox[SKY_RIGHT] = LoadBMP("C:\\Users\\hp\\OneDrive\\Desktop\\mini\\BMP11\\right.bmp");
		skybox[SKY_LEFT] = LoadBMP("C:\\Users\\hp\\OneDrive\\Desktop\\mini\\BMP11\\left.bmp");
		skybox[SKY_UP] = LoadBMP("C:\\Users\\hp\\OneDrive\\Desktop\\mini\\BMP11\\up.bmp");
		grass=LoadBMP("C:\\Users\\hp\\OneDrive\\Desktop\\mini\\BMP11\\grass_1.bmp");
	}
	else if(background==1)
	{
		skybox[SKY_DOWN] = LoadBMP("C:\\Users\\hp\\OneDrive\\Desktop\\mini\\BMP12\\down.bmp");
		skybox[SKY_FRONT] = LoadBMP("C:\\Users\\hp\\OneDrive\\Desktop\\mini\\BMP12\\front.bmp");
		skybox[SKY_BACK] = LoadBMP("C:\\Users\\hp\\OneDrive\\Desktop\\mini\\BMP12\\back.bmp");
		skybox[SKY_RIGHT] = LoadBMP("C:\\Users\\hp\\OneDrive\\Desktop\\mini\\BMP12\\right.bmp");
		skybox[SKY_LEFT] = LoadBMP("C:\\Users\\hp\\OneDrive\\Desktop\\mini\\BMP12\\left.bmp");
		skybox[SKY_UP] = LoadBMP("C:\\Users\\hp\\OneDrive\\Desktop\\mini\\BMP12\\up.bmp");
		grass=LoadBMP("C:\\Users\\hp\\OneDrive\\Desktop\\mini\\BMP12\\grass_1.bmp");
	}
...
void display(){
	...
	if(help)
	{
		...
		drawText("Developed by Navin Tiwari (1BY17CS099)", 0,-0.45,0.82);
		glEnable(GL_LIGHTING);
		glPopMatrix();
	}
	else
